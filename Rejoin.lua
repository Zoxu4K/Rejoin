...
local REEL_DELAY = 0.01 -- Delay antar tap (detik)
...
local function startAutoReel()
    spawn(function()
        while true do
            if AUTO_REEL then
                pcall(function()
                    -- Click di pojok kiri atas (area kosong)
                    local clickX = 50
                    local clickY = 50
    ...
    local success, err = pcall(function()
        ...
        reelBtn.MouseButton1Click:Connect(function()
            ...
            if AUTO_REEL then
                ...
                createNotification("🎣 Auto Reel", "Auto reel enabled!", 3)
            else
                reelBtn.BackgroundColor3 = Color3.fromRGB(170, 0, 0)
        ...
        clearBtn.Size = UDim2.new(0.24, -2, 0, 35)
        clearBtn.Position = UDim2.new(0.76, 0, 1, -40)
        clearBtn.BackgroundColor3 = Color3.fromRGB(100, 0, 100)
        ...
        clearBtn.MouseButton1Click:Connect(function()
            ...
            createNotification("🗑️ Cleared", "Log history cleared!", 2)
        end)
...
local function startAutoRejoin()
    ...
    log("🎣 AUTO REEL: OFF (Default)", "info")
    ...
    spawn(function()
        ...
        while true do
            if IS_RUNNING then
                if countdown > 0 then
                    if countdown % 5 == 0 or countdown <= 3 then
...
log("🎣 Auto Reel: Press 🎣 button to toggle", "info")
